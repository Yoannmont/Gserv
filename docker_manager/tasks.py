...
def install_mod_task(server_id: int, mod_id: int):
    ...
    try:
        ...
        beat_logger.info(f"[docker_manager] Mod {mod.name} installed on {server.name}")

    except Exception as e:
        beat_logger.error("[docker_manager] Error during mod installation: %r", e)
        raise
...
def uninstall_mod_task(server_id: int, mod_id: int):
    ...
    try:
        ...
        beat_logger.info(f"[docker_manager] Mod {mod.name} uninstalled from {server.name}")

    except Exception as e:
        beat_logger.error("[docker_manager] Error during mod uninstallation: %r", e)
        raise
